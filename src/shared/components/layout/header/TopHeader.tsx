...
function TopHeader({ headerLogic, isScrolled = false }: TopHeaderProps) {
  ...
  const styles = useMemo(() => ({
    wrapperBg: isScrolled
      ? "border-b border-border-light bg-surface-primary shadow-lg"
    ...
    <div className={`transition-[background-color,border-color,box-shadow] duration-500 ease-in-out will-change-[background-color,box-shadow] ${styles.wrapperBg}`}>
      <div className={`shell flex flex-col gap-1 md:flex-row md:items-center md:justify-between md:gap-6 ${styles.shell}`}>
        ...
        <div className="flex items-center justify-between gap-3 w-full lg:w-auto">
          ...
          >
            <div className={`flex items-center justify-center rounded-lg bg-surface-secondary border border-border-light overflow-hidden transition-all duration-300 ease-out ${styles.logoContainer}`}>
              <Image
            ...
            <div className="flex flex-col">
              <span className={`font-black tracking-tight text-text-primary leading-tight uppercase ${styles.logoText}`}>
                Aura
              </span>
          ...
          <div className="hidden rounded-md border border-border-light bg-surface-secondary px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-text-secondary lg:flex lg:items-center lg:gap-2">
        ...
        <div className="flex w-full items-center gap-1.5 lg:w-auto lg:gap-6">
          ...
          <div className="hidden items-center gap-4 border-l border-border-light pl-4 lg:flex lg:gap-6 lg:pl-6">
