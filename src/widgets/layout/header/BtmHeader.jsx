      ...
      <div className="shell flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="relative hidden lg:block" data-categories-menu>
            ...
            {openDesktopCategories && (
              <div
                className={`absolute top-[calc(100%+12px)] z-20 w-[58rem] max-w-[calc(100vw-4rem)] overflow-hidden rounded-[30px] border border-slate-200 bg-white p-4 shadow-[0_24px_70px_rgba(15,23,42,0.18)] ${
              ...
              >
                {categories.length > 0 ? (
                  <div>
                    <div
                      className={`mb-5 flex items-end justify-between gap-4 border-b border-slate-200 pb-4 ${
                    ...
                    <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                      {categories.map((category) => (
                        <Link
                          ...
                          className="group rounded-[22px] border border-slate-200 bg-white p-4 transition hover:border-slate-300 hover:bg-slate-50"
                          onClick={closeAll}
                        >
                          <div
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  onClick={closeAll}
                >
                  <span className="text-base text-slate-300">{link.icon}</span>
                  {link.name}
                </Link>
              );
            })}
        ...
        <div className="flex items-center gap-3">
          <HeaderIcons />
          <button
            className="flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 bg-white text-xl text-slate-700 lg:hidden"
