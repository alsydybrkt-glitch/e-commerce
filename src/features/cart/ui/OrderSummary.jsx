    ...
    >
      ...
      <form className="mt-6 space-y-3" onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-200"
        />
